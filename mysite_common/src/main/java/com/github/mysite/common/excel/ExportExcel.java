...
import com.github.mysite.common.utils.Reflections;
...
public class ExportExcel {
    ...
    public ExportExcel(String title, Class<?> cls, Workbook wb, int type){
        ...
        getClassFieldMethod(cls, type);
        Class<?> superclass = cls.getSuperclass();
        // 如果有父类，则获取一级父类的属性注解 ExcelField
        if (null != superclass) {
            getClassFieldMethod(superclass, type);
        }
        // Field sorting
    ...
    private void getClassFieldMethod(Class<?> cls, int type) {
    ...
    public Cell addCell(Row row, int column, Object val, int align, Class<?> fieldType) {
        ...
        try {
            ...
            if (newVal instanceof String) {
                ...
                cell.setCellValue(newVal.toString());
